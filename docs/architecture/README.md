...
2. [ADR implementation status](adr/implementation-status.md) owns repository evidence and remaining
   gaps.
3. The active [reference-game product readiness and delivery reset
   plan](../plans/2026-08-01-001-refactor-product-readiness-delivery-reset-plan.md) owns current
   execution order.
