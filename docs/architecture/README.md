...
2. [ADR implementation status](adr/implementation-status.md) owns repository evidence and remaining
   gaps.
3. The active [reference-game runtime authority and product delivery
   plan](../plans/2026-07-21-001-refactor-runtime-authority-product-delivery-plan.md) owns current
   execution order.
