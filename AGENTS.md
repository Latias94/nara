...
- Asset/data reload does not imply Rust machine-code hot replacement. Native hot reload requires a separate ABI, quiescence, state-migration, native-handle, and rollback ADR after measured rebuild-and-restart pressure exists.
